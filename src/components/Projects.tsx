...
const WindowControls: React.FC = () => (
    <div className="flex gap-2">
        <div
            ...
            style={{ backgroundColor: C.dotRed }}
        />
        <div
            className="w-3 h-3 rounded-full"
            style={{ backgroundColor: C.dotYellow }}
        />
        <div
            className="w-3 h-3 rounded-full"
            style={{ backgroundColor: C.dotGreen }}
        />
    </div>
)
    ...
    const infoBlock = (
        <div
            className={`lg:col-span-5 flex flex-col z-20 ${
                reversed ? 'lg:items-start order-2 lg:order-1' : 'lg:text-right lg:items-end'
            }`}
        >
            {/* label */}
            <p
                className="font-jetbrains text-sm mb-2"
        ...
        >
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="flex items-center gap-4 mb-16">
                    <h2
                        className="font-jetbrains text-3xl font-bold"
                        style={{ color: C.white }}
                    >
                        Featured Projects
                    </h2>
